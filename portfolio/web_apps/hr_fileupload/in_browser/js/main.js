...
//PDFTron's Webviewer PdfNetJS.TextExtract
            (function (exports) {
                "use strict";
                    ...
                    function* main() {
                        ...
                        try {
                            ...
                            if (example3_wordlist) {
                                ...
                                var word;
                                for (;
                                    (yield line.isValid()); line = (yield line.getNextLine())) {
                                    for (word = yield line.getFirstWord();
                                        (yield word.isValid()); word = (yield word.getNextWord())) {
...
/*      (myResume.files[0].type === 'application/pdf')
        (myResume.files[0].type === 'application/msword')
*/
